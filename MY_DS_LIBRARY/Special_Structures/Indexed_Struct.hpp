...
private:
	...
	typedef typename TMP::nth_type<(capacity<=255?0:(capacity<=65535?1:(capacity<=4294967295?2:3))),
						  			unsigned char, unsigned short, unsigned int, size_t>::type offset_type;
