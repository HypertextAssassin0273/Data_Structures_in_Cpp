...
template<typename T>
class SLL{//i.e. Singly Linked-List (same as STL::forward_list)
...
//	}
	...
	void merge(SLL &other,const __int64& pos=0){
...
//	test_case_1();//use of all operations
	test_case_2();//using SLL as stack with LIFO order (best-case)
    return 0;
}
